...
namespace RentalCar {
    ...
    public partial class RentalCarDataSet : global::System.Data.DataSet {
        ...
        public partial class UserInfoDataTable : global::System.Data.TypedTableBase<UserInfoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserInfoRow AddUserInfoRow(string user_id, string password) {
        ...
        public partial class UserInfoRow : global::System.Data.DataRow {
            ...
            public string user_id {
                get {
                    try {
                        return ((string)(this[this.tableUserInfo.user_idColumn]));
                    }
...
namespace RentalCar.RentalCarDataSetTableAdapters {
    ...
    public partial class UserInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UserInfo] WHERE (([id] = @Original_id) AND ((@IsNull_user_id =" +
                " 1 AND [user_id] IS NULL) OR ([user_id] = @Original_user_id)) AND ((@IsNull_pass" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserInfo] ([user_id], [password]) VALUES (@user_id, @password)" +
                ";\r\nSELECT id, user_id, password FROM UserInfo WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[UserInfo] SET [user_id] = @user_id, [password] = @password WHERE (([id] = @Original_id) AND ((@IsNull_user_id = 1 AND [user_id] IS NULL) OR ([user_id] = @Original_user_id)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)));
SELECT id, user_id, password FROM UserInfo WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, user_id, password FROM dbo.UserInfo";
        ...
        public virtual int Fill(RentalCarDataSet.UserInfoDataTable dataTable) {
        ...
        public virtual RentalCarDataSet.UserInfoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RentalCarDataSet.UserInfoDataTable dataTable = new RentalCarDataSet.UserInfoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RentalCarDataSet.UserInfoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_user_id, string Original_password) {
        ...
        public virtual int Update(string user_id, string password, int Original_id, string Original_user_id, string Original_password, int id) {
            if ((user_id == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string user_id, string password, int Original_id, string Original_user_id, string Original_password) {
            return this.Update(user_id, password, Original_id, Original_user_id, Original_password, Original_id);
        }
    }
